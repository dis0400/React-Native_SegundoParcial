import { FlingGestureHandlerEventPayload } from 'react-native-gesture-handler/lib/typescript/handlers/FlingGestureHandler';
import { ForceTouchGestureHandlerEventPayload } from 'react-native-gesture-handler/lib/typescript/handlers/ForceTouchGestureHandler';
...
import { LongPressGestureHandlerEventPayload } from 'react-native-gesture-handler/lib/typescript/handlers/LongPressGestureHandler';
import { PanGestureHandlerEventPayload } from 'react-native-gesture-handler/lib/typescript/handlers/PanGestureHandler';
import { PinchGestureHandlerEventPayload } from 'react-native-gesture-handler/lib/typescript/handlers/PinchGestureHandler';
import { RotationGestureHandlerEventPayload } from 'react-native-gesture-handler/lib/typescript/handlers/RotationGestureHandler';
import { TapGestureHandlerEventPayload } from 'react-native-gesture-handler/lib/typescript/handlers/TapGestureHandler';
import { NativeViewGestureHandlerPayload } from 'react-native-gesture-handler/lib/typescript/handlers/NativeViewGestureHandler';
